...
/**
 * Thin HTTP client for the AWS Cognito `InitiateAuth` endpoint.
 *
...
class HttpCognitoAuthClient(
    ...
    override suspend fun refresh(refreshToken: String): Result<AuthenticationResult> =
        initiateAuth(
